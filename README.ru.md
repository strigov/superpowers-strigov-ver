...
![Версия](https://img.shields.io/badge/version-0.6.0-6c63ff)
...
> Текущая версия исходников: **0.6.0**
...
| Основной ревьюер кода | Claude Opus с `ultrathink` | На каждой фазе проверяет соответствие плану и качество кода. |
...
`ultra` никогда не выбирается автоматически. Автор плана использует его только тогда, когда пользователь явно попросил `ultra` в своём запросе.
